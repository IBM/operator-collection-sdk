...
description: "Contribution guidelines for the IBM Operator Collection SDK VS Code Extension."
icon: "library_add"
...
![Git Flow](/images/vs-code-extension/Gitflow.png)
...
For a list of the maintainers, see the [MAINTAINERS.md](https://github.com/IBM/operator-collection-sdk-vscode-extension/blob/main/MAINTAINERS.md) page.

## Legal
---
Each source file must include a license header for the [Apache Software License 2.0](https://github.com/IBM/operator-collection-sdk-vscode-extension/blob/main/LICENSE). 
...
reported by contacting the [project team](https://github.com/IBM/operator-collection-sdk-vscode-extension/blob/main/MAINTAINERS.md). All
